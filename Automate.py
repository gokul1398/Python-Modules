...
excel1 = 'shift-data.xlsx'
excel2 = 'third-shift-data.xlsx'

df_first_shift = pd.read_excel(excel1, sheet_name='first')
df_second_shift = pd.read_excel(excel1, sheet_name='second')
df_third_shift = pd.read_excel(excel2)
